...
//    );
    ...
    public function getCMSFields()
    {
        ...
        if (!$this->blockManager) {
            $this->blockManager = singleton(BlockManager::class);
        }
        ...
        $fields->addFieldToTab('Root.Main',
            DropdownField::create('ClassName', 'Block Type', $classes)->addExtraClass('block-type'), 'Title');
        ...
        if (Controller::curr()->class == 'CMSPageEditController') {
            ...
            $fields->addFieldToTab(
                'Root.Main',
                DropdownField::create('ManyMany[BlockArea]', 'BlockArea',
                    $this->blockManager->getAreasForPageType($currentPage->ClassName))
        ...
        $viewersOptionsSource["OnlyTheseUsers"] = _t('SiteTree.ACCESSONLYTHESE',
    ...
    public function onAfterDelete()
    {
        ...
        if (Versioned::get_reading_mode() == 'Stage') {
